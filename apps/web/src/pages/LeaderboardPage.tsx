      ...
      {entries.length >= 3 && (
        <div className="flex items-end justify-center gap-3">
          ...
          <div className="flex flex-col items-center" style={{ animation: "stagger-in 0.5s ease-out 0.1s both" }}>
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[var(--color-border)] text-sm font-bold text-[var(--color-text-muted)] ring-2 ring-gray-300 dark:ring-warm-600 overflow-hidden">
            ...
            <span className="mt-1 max-w-[80px] truncate text-xs font-medium text-[var(--color-text-muted)]">{entries[1].displayName ?? "Anonymous"}</span>
            <div className="mt-1 flex h-16 w-20 items-center justify-center rounded-t-lg bg-[var(--color-border)]">
          ...
          <div className="flex flex-col items-center" style={{ animation: "stagger-in 0.5s ease-out both" }}>
            ...
            <span className="mt-1 max-w-[80px] truncate text-xs font-semibold text-[var(--color-text)]">{entries[0].displayName ?? "Anonymous"}</span>
          ...
          <div className="flex flex-col items-center" style={{ animation: "stagger-in 0.5s ease-out 0.2s both" }}>
            ...
            <span className="mt-1 max-w-[80px] truncate text-xs font-medium text-[var(--color-text-muted)]">{entries[2].displayName ?? "Anonymous"}</span>
              ...
              >
                ...
                >
                  {entry.avatarUrl ? (
                    ...
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[var(--color-border)] text-xs font-medium text-[var(--color-text-muted)]">
