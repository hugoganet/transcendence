...
export function TermsOfService() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8 text-[var(--color-text)]">
      ...
      <h1 className="mb-6 text-3xl font-bold text-[var(--color-text)] font-heading">{t("pages.termsOfService.title")}</h1>
      <p className="mb-8 text-sm text-[var(--color-text-muted)]">{t("pages.termsOfService.lastUpdated")}</p>
